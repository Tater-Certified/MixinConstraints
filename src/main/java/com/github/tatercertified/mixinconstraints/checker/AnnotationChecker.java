...
import com.github.tatercertified.mixinconstraints.annotations.*;
...
public class AnnotationChecker {
    ...
    private static final Set<String> CONSTRAINT_ANNOTATION_DESCS = Set.of(
            IF_MOD_LOADED_DESC,
            IF_MOD_LOADEDS_DESC,
            IF_MOD_ABSENT_DESC,
            IF_MOD_ABSENTS_DESC,
    ...
    public static boolean isConstraintAnnotationNode(AnnotationNode node) {
        return node != null && CONSTRAINT_ANNOTATION_DESCS.contains(node.desc);
    }
